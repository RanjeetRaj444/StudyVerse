        ...
        <DIV>
            <Accordion allowToggle>
                <AccordionItem>
                    <h2>
                        <AccordionButton>
                            <Box className='FAQsTitle' as="span" flex='1' textAlign='left' style={{ fontFamily: 'hurme_no2-webfont,-apple-system,BlinkMacSystemFont,sans-serif', color: "#2e3856", fontWeight: "bold" }}
                            >
                ...
                <AccordionItem>
                    <h2>
                        <AccordionButton>
                            <Box as="span" flex='1' className='FAQsTitle' textAlign='left' style={{ fontFamily: 'hurme_no2-webfont,-apple-system,BlinkMacSystemFont,sans-serif', color: "#2e3856", fontWeight: "bold" }}>
                ...
                <AccordionItem>
                    <h2>
                        <AccordionButton>
                            <Box as="span" flex='1' textAlign='left' className='FAQsTitle' style={{ fontFamily: 'hurme_no2-webfont,-apple-system,BlinkMacSystemFont,sans-serif', color: "#2e3856", fontWeight: "bold" }}>
