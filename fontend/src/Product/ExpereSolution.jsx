    ...
    <DIV>
      ...
      <div className='topSection'>
        ...
        <div style={{ position: 'relative' }}>
          ...
          <Image width={{base: 40, sm: 150, md: 200, lg: 300 }} className='excercise' src='https://quizlet.com/_next/static/media/landing-page-header-phone-exercise.01626b15.svg' alt='Dan Abramov' />


          <Image width={{ base: 40,sm: 150, md: 200, lg: 300 }} className='solution' src='https://quizlet.com/_next/static/media/landing-page-header-phone-solution.f3708594.svg' alt='Dan Abramov' />
